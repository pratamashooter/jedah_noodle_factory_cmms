    ...
    <td class="actions">
      <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
          <a class="dropdown-item menu-drop view-btn" role="button" data-toggle="modal" data-target="#viewModal" href="" id="{{ $schedule->id }}" data-code="{{ $schedule->schedule_list_code }}"><i class="mdi mdi-eye"></i>View</a>
          <a class="dropdown-item menu-drop delete-btn" href="{{ url('delete_schedule_list/'. $schedule->id ) }}"><i class="mdi mdi-delete-sweep"></i>Delete</a>
        </div>
      </div>
    </td>
  </tr>
